...
const CreateAssignment = () => {
    ...
    const submitHandler = () => {
        ...
        if (
            !sendQuestionData.due ||
            !sendQuestionData.title ||
            !sendQuestionData.questions
        ) {
            //empty field
            setErr('Empty field!');
        } else {
    ...
    const prevIsValid = () => {
        ...
        const someEmpty = form.some(
            (item) =>
                item.Correct === '' ||
                item.Correct === 'Select the Correct Option' ||
                item.Option1 === '' ||
                item.Option2 === '' ||
                item.Option3 === '' ||
                item.Option4 === '' ||
            ...
            <div className="p-5">
                <div className="container col-12 col-md-9 mt-5 p-5 bg-white form_bg">
                    ...
                    <form>
                                ...
                                <div className="row justify-content-center align-content-center mb-3">
                                    <div className="col-12 col-md-5 p-2">
                                        ...
                                        >
                                            ...
                                            <option value={item.Option1}>
                                                {item.Option1}
                                            </option>
                                            <option value={item.Option2}>
                                                {item.Option2}
                                            </option>
                                            <option value={item.Option3}>
                                                {item.Option3}
                                            </option>
                                            <option value={item.Option4}>
                                                {item.Option4}
                                            </option>
                                        </select>
                                        {item.errors.Correct && (
                        ...
                        <button
                            className="btn btn-outline-dark mt-2 form_bg"
                    ...
                    <button
                        ...
                        className="btn btn-outline-success mt-2 form_bg"
                    >
                        Post the Assignment
                    </button>
